      ...
      <div className="mb-16 md:px-0 px-5">
        <div className="content">
          <div className="md:col-span-8">
            ...
            <h2>
              Where every details metters <span className="text-white">-</span>
          ...
          <div className="sub-content">
            <p>
              Every cocktail we serve is a reflection of our obbsesion with
              detail - from the first muddle to final garnish. That care is what
              turn a simple drink into something truely memorable.
            </p>
